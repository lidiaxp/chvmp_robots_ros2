<launch>
    ...
    <arg name="ros_control_file"   default="$(find-pkg-share spot_config)/config/ros_control/ros_control.yaml" /> <!-- Path to ROS Control configurations. Do not touch. -->
    <arg name="gazebo_world"       default="$(find-pkg-share spot_config)/worlds/outdoor.world" /> <!-- Path to Gazebo world you want to load. -->
    ...
    <include file="$(find-pkg-share spot_config)/launch/bringup.launch">
    ...
    <include file="$(find-pkg-share champ_gazebo)/launch/spawn_robot.launch">
        <arg name="robot_name"         value="$(var robot_name)"/>
        <arg name="lite"               value="$(var lite)"/>
